...
shadow_layer = Layer(name="shadow", raw_image=raw_image, threshold_percent=threshold_lines[0], canvas_color=(0, 0, 0))
midtone_layer = Layer(name="midtone", raw_image=raw_image, threshold_percent=threshold_lines[1], canvas_color=(0x58, 0x09, 0x9C))
fleshtone_layer = Layer(name="fleshtone", raw_image=raw_image, threshold_percent=threshold_lines[2], canvas_color=(0xFF, 0xAE, 0))
highlights_layer = Layer(name="highlights", raw_image=raw_image, threshold_percent=threshold_lines[3], canvas_color=(255, 255, 0))
